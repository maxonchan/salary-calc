...
def get_tax_rates():
    return {
        ...
        "social_insurance": {
            ...
            "nursing_care_rate": 0.00795,   # 0.795% (Employee part, age 40-64)
            "child_support_rate": 0.00115,  # 0.115% (Employee part, 2026+)
        ...
        "resident_tax": {
            ...
            "basic_deduction": 430000 # Resident tax basic deduction is different
        },
